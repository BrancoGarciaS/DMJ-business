    ...
    <div class="flex h-full antialiased text-gray-800">
        ...
        <div class="flex flex-col py-8 pl-6 pr-2 w-64 bg-white flex-shrink-0">
            <div class="flex flex-row items-center justify-center h-12 w-full">
                ...
                <div class="ml-2 font-bold text-lg">Atención al Cliente</div>
            </div>
            <div class="flex flex-col items-center justify-center bg-indigo-100 border border-gray-200 mt-4 w-full py-6 px-4 rounded-lg">
                ...
                <div class="text-sm font-semibold mt-2">Chile a Domicilio</div>
                <div class="text-xs text-gray-500 text-center">De la tienda a tu puerta, sin demoras</div>
            </div>
            <div class="flex flex-col mt-8">
            <div class="flex flex-row items-center justify-between text-xs">
                <span class="font-bold text-xs">Contactos Administrativos</span>
            </div>
            <div class="flex flex-col space-y-1 mt-4 -mx-2 h-64 overflow-y-auto">
                {admins.map(admin => (
                    <button class="flex flex-row items-center hover:bg-gray-100 rounded-xl p-2">
                        ...
                        <div class="ml-2 text-sm font-semibold">{admin.name}</div>
                    </button>
                ))}
            </div>
            </div>
